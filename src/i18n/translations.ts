	...
	en: {
		...
		pages: {
			wallets: {
				...
				footnote:
					'All data represents current accumulation state. On-chain verification links will be provided.',
		...
		home: {
			hero: {
				...
				description:
					'A disciplined control surface for simulation, treasury visibility, and narrative timing—built for operators who think in phases, not headlines.',
	...
	ru: {
		...
		pages: {
			wallets: {
				...
				footnote:
					'Все данные отражают текущее состояние накопления. Ссылки для ончейн-проверки будут добавлены.',
		...
		home: {
			hero: {
				...
				description:
					'Сдержанная панель для симуляции, видимости казны и тайминга нарратива — для тех, кто мыслит фазами, а не заголовками.',
	...
	fr: {
		...
		pages: {
			wallets: {
				...
				footnote:
					'Toutes les données reflètent l’état actuel de l’accumulation. Des liens de vérification on-chain seront fournis.',
		...
		home: {
			hero: {
				...
				description:
					'Une surface de contrôle sobre pour la simulation, la visibilité trésorerie et le timing narratif — pensée pour les opérateurs qui raisonnent par phases.',
